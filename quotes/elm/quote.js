		...
		return _elm_lang$http$Http$request(
			{
				...
				headers: {
					ctor: '::',
					_0: A2(_elm_lang$http$Http$header, 'X-Mashape-Authorization', 'qKPbfOzWKemsh2qi30QgbOA1WufXp1ok1NsjsnAkvh6yVJfaAk'),
					_1: {ctor: '[]'}
				},
				url: url,
				body: _elm_lang$http$Http$emptyBody,
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {quote: a, author: b, error: c};
	});
...
var _user$project$Main$pullNewQuote = function () {
	var url = 'https://andruxnet-random-famous-quotes.p.mashape.com/?cat=movies';
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$NewQuote,
		A2(_user$project$Main$get, url, _user$project$Main$decodeQuote));
}();
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A3(_user$project$Main$Model, 'Shit happens', 'Anon', _elm_lang$http$Http$Timeout),
	_1: _user$project$Main$pullNewQuote
};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'GetQuote') {
			return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$pullNewQuote};
		} else {
			if (_p0._0.ctor === 'Ok') {
				var _p1 = _p0._0._0;
				return {
						...
						_0: A2(
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], '- ', model.author)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
